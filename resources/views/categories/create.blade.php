...
<div class="mb-6">
    ...
    <p class="text-gray-500 text-sm mt-1">Create a new category for your transactions.</p>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 max-w-2xl overflow-hidden" x-data="{
    ...
    <form action="{{ route('categories.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" required class="w-full rounded-xl border border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 p-2.5 outline-none placeholder-gray-400" placeholder="e.g. Groceries">
                </div>
        ...
        <div class="pt-6 border-t border-gray-100 flex justify-end gap-3 mt-8">
            ...
            <button type="submit" class="px-6 py-2.5 text-sm font-medium text-white bg-primary rounded-xl shadow-sm hover:bg-emerald-600 transition">Create Category</button>
        </div>
    </form>
</div>
@endsection
