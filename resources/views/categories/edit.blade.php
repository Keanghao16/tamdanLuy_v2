...
<div class="mb-6 flex flex-col gap-4">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5">Modify properties inside your localized tracking channel context.</p>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 w-full overflow-hidden" x-data="{
    ...
    <form action="{{ route('categories.update', $category) }}" method="POST" class="p-6 md:p-8 text-left">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $category->name) }}" required class="w-full text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary p-3 outline-none shadow-sm transition-all text-gray-700 placeholder-gray-400" placeholder="e.g. Groceries">
                    </div>
